...
C      WARNING - NEW VARIABLES ---
      ...
      real, dimension(nx,ny,12):: bl1,bl2,bl3 ! carbon allocated to growth (monthly sums)
...
!
!     PFT       1       2       3                  
      data dt1/3.77,   4.15,   2.98/ !g1   
      data dt2/5.9E-5, 3.4E-5, 3.2E-5/ !vcmax       
      data dt3/0.30,   0.35,   0.35/ !aleaf  
      data dt4/0.35,   0.35,   0.20/ !aawood  
      data dt5/0.35,   0.30,   0.45/ !afroot   
      data dt6/3.0,    2.0,    2.0/ !tleaf   
      data dt7/30.0,   30.0,   20.0/ !tawood   
      data dt8/2.0,    2.0,    2.5/ !tfroot      
c
c
      if(par .eq. 1 ) then      ! g1
         dt(:) = dt1(:)
