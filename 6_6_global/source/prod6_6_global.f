...
!     ---------
      ...
      real tleaf(6)             !leaf turnover time (yr)
      real p21(6)
...
!     ----------------------------------------------     
      ...
      alfm = 1.391
      gm = 3.26 * 86400.           !(*86400 transform mm/s para mm/dia)
...
!
!      sla=(0.03*(365/(tleaf(pft)/365))**(-0.46))
!      
!
!      laia64 = (cl1 * 1000 * 365.0 * sla)
!      print*, laia64
!     Leaf area index (m2/m2)
...
!     
      ...
      delta_e = es*(1. - ur)    !mb
!     
      if ((delta_e.ge.(1./h5)-0.5).or.(rc2.ge.1000.0)) evap = 0. !valor teste
      if ((delta_e.lt.(1./h5)-0.5).or.(rc2.lt.1000.0)) then !valor teste
!     
!     Gama and gama2
!     --------------
